		...
		<div class="project-item" onclick="location = '<?php echo $project['primary_link'] ?>'" style="background-image: url('/assets/images/projects/<?php echo $project['thumbnail'] ?>');">
			<div class="content">
				<div class="links">
					<?php foreach ($project['links'] as $link) { ?>
						<a class="link" href="<?php echo $link['url'] ?>">
							<?php if ($link['type'] == 'source') { ?>
								<svg viewBox="0 0 24 24" style="width: 3rem; height: 3rem;" role="presentation">
									<path
				...
				<div class="information">
					...
					<div class="stack"><?php echo implode(', ', $project['stack']) ?></div>
				</div>
			</div>
		</div>
	<?php } ?>
